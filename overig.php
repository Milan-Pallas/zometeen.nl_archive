...
<head>
    ...
    categorie = 'overig' ORDER BY datum_geplaatst DESC");

    $afbeelding_naamPDO = $pdo ->query("SELECT afbeelding_naam FROM nieuwsberichten WHERE
    categorie = 'overig' ORDER BY datum_geplaatst DESC LIMIT 1");
...
<body>
    ...
    <div class="titel">
        ...
        <h1 class="overig">Overig</h1>
        <p>Alle overige nieuwtjes</p>
    </div>
    <div class="algemeen">
        <div>
