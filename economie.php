...
<head>
    ...
    categorie = 'economie' ORDER BY datum_geplaatst DESC");

    $afbeelding_naamPDO = $pdo ->query("SELECT afbeelding_naam FROM nieuwsberichten WHERE
    categorie = 'economie' ORDER BY datum_geplaatst DESC LIMIT 1");
...
<body>
    ...
    <div class="titel">
        ...
        <h1 class="economie">Economie</h1>
        <p>Alle nieuwtjes over economie</p>
    </div>
    <div class="algemeen">
        <div>
